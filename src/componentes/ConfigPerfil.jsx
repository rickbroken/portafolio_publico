...
const ConfigPerfil = ({ setConfig, perfil }) => {
  ...
  const [tiktok, setTiktok] = useState(perfil[0].tiktok);
  const [youtube, setYoutube] = useState(perfil[0].youtube);
        ...
        <div className='flex flex-col w-full'>
          <div className='sm:flex w-full items-between'>
            ...
            <div className='flex flex-col sm:w-1/2 items-center'>
              ...
              <div className='w-[92%]'>
                <p>Tiktok:</p>
                <input className='py-2 px-3 rounded-sm outline-none mb-5 w-full' type="text" value={tiktok} onChange={(e) => setTiktok(e.target.value)} />
              </div>
            </div>
          ...
          <div className='mx-4'>
            <p>Youtube:</p>
            <input className='py-2 px-3 rounded-sm outline-none mb-5 w-full' type="text" value={youtube} onChange={(e) => setYoutube(e.target.value)} />
          </div>
